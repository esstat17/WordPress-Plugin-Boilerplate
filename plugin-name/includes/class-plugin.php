...
class Plugin_Name {
	...
	public function __construct() {
		...
		$this->plugin_name = 'plugin-name'; // Replace this!
		$this->version = '1.0.0';
	...
	private function set_locale() {
		...
		$plugin_i18n = new Plugin_i18n( $this->get_plugin_name(), $this->get_version() );
